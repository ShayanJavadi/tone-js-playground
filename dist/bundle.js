...
const reallyBigNumber = "";
...
const synth1 = new __WEBPACK_IMPORTED_MODULE_0_tone___default.a.Synth();
const synth2 = new __WEBPACK_IMPORTED_MODULE_0_tone___default.a.Synth();
const synth3 = new __WEBPACK_IMPORTED_MODULE_0_tone___default.a.Synth();
const synth4 = new __WEBPACK_IMPORTED_MODULE_0_tone___default.a.Synth();
const notes = "ABCDEFGABC";
function triggerSynth(time){
	//the time is the sample-accurate time of the event
	synth1.triggerAttackRelease(`${notes[reallyBigNumber[Math.floor(time)]]}4`, '16n', time + Math.floor(Math.random() * (2 - 1)) + 1);
}
synth1.toMaster();
synth2.toMaster();
synth3.toMaster();
...
for (var i = 1; i < 100; i++) {
	iteration = i;
	__WEBPACK_IMPORTED_MODULE_0_tone___default.a.Transport.schedule(triggerSynth, i);
}

__WEBPACK_IMPORTED_MODULE_0_tone___default.a.Transport.bpm.value = 500;
__WEBPACK_IMPORTED_MODULE_0_tone___default.a.Transport.start('+0.5');
